        ...
        return {
          ...
          edge: {
            ...
            seam: {
              ...
              opacity: seamEnabled
                ? clamp(tri(0.15, (base as any).edge.seam.opacity, 1.0), 0, 1)
                : (base as any).edge.seam.opacity,
            ...
            band: {
              ...
              opacity: bandEnabled
                ? clamp(tri(0.05, (base as any).edge.band.opacity, 0.75), 0, 1)
                : (base as any).edge.band.opacity,
