...
function createColorwhirlEditorElement() {
  return class ColorwhirlEditorElement extends HTMLElement {
...
export function registerColorwhirlEditorElement(tagName = 'colorwhirl-editor') {
  if (typeof window === 'undefined' || typeof customElements === 'undefined' || typeof HTMLElement === 'undefined') {
    return;
  }

  if (!customElements.get(tagName)) {
    customElements.define(tagName, createColorwhirlEditorElement());
  }
}
